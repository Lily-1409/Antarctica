...
/* harmony import */ var _modules_map__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/map */ "./js/modules/map.js");
...
/* harmony import */ var _modules_mobile_menu__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/mobile-menu */ "./js/modules/mobile-menu.js");
/* harmony import */ var _modules_mobile_menu__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_mobile_menu__WEBPACK_IMPORTED_MODULE_4__);
...
function getTileContainer(layer) {
  for (var k in layer) {
    if (layer.hasOwnProperty(k)) {
      if (layer[k] instanceof window.ymaps.layer.tileContainer.CanvasContainer || layer[k] instanceof window.ymaps.layer.tileContainer.DomContainer) {
        return layer[k];
      }
    }
  }
...
var menuButton = document.querySelector('.main-nav-toogle');
var svg = menuButton.querySelectorAll('svg');
var iconOpen = menuButton.querySelector('.main-nav-toogle__iconOpen');
var iconClose = menuButton.querySelector('.main-nav-toogle__iconClose');
var nav = document.querySelector('.navigation-list');
var header = document.querySelector('.header');
menuButton.addEventListener('click', function () {
  for (var i = 0; i < svg.length; i++) {
    var currentIcon = svg[i];
...
// скролл до блоков
var triggers = [].slice.call(document.querySelectorAll('.wrapper a[href^="#"]'));
